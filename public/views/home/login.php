            ...
            <div class="form-group">
                ...
                <div class="wrapper-input">
                    ...
                    <div class="input-group">
                        ...
                        <input autofocus class="form-control" type="text" autocomplete="username" id="login" name="login" required maxlength="60" title="Por favor, informe seu usuário ou email">
